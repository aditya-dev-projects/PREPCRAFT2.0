...
const Chapter5 = ({ noteId }: { noteId: string }) => {
  switch (noteId) {
    case 'basic-of-oops':
      return (
        <div className="w-full px-4 sm:px-6 py-6 bg-white text-gray-900">
          <h2 className="text-3xl font-bold mb-4">5.1: Basic Of OOPs</h2>
    ...
    case 'advanced-oops':
      return (
        <div className="w-full px-4 sm:px-6 py-6 bg-white text-gray-900">
          <h2 className="text-3xl font-bold mb-4">5.2: Advanced OOPs</h2>
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <p className="text-lg text-muted-foreground">
              Detailed notes for this section are coming soon. Stay tuned!
            </p>
    ...
    default:
      return (
        <div className="w-full px-4 sm:px-6 py-6 bg-white text-gray-900">
          <h1 className="text-3xl font-bold mb-4">Chapter 5: Object Oriented Programming</h1>
