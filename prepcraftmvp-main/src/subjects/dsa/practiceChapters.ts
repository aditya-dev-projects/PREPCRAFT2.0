const chapter1Practice = {
  ...
  subchapters: [
    ...
    { id: 'operators-problem', title: 'Operators', problemId: 'operators-problem' },
    { id: 'loops-problem', title: 'Loops', problemId: 'loops-problem' },
    { id: 'functions-problem', title: 'Functions', problemId: 'functions-problem' },
  ],
};
...
const chapter2Practice = {
  ...
  subchapters: [
    ...
    { id: 'strings-problem', title: 'Strings', problemId: 'strings-problem' },
  ],
};
...
const chapter3Practice = {
  ...
  subchapters: [
    ...
    { id: 'selection-sort-problem', title: 'Selection Sort', problemId: 'selection-sort-problem' },
    { id: 'insertion-sort-problem', title: 'Insertion Sort', problemId: 'insertion-sort-problem' },
    { id: 'counting-problem', title: 'Counting', problemId: 'counting-problem' },
  ],
};
...
const chapter4Practice = {
  ...
  subchapters: [
    ...
    { id: 'divide-and-conqueror-problem', title: 'Divide & Conqueror', problemId: 'divide-and-conqueror-problem' },
    { id: 'bit-manipulation-problem', title: 'Bit Manipulation', problemId: 'bit-manipulation-problem' },
    { id: 'time-and-space-complexity-problem', title: 'Time & Space Complexity', problemId: 'time-and-space-complexity-problem' },
    { id: 'greedy-algorithim-problem', title: 'Greedy Algorithm', problemId: 'greedy-algorithim-problem' },
  ],
};
...
const chapter6Practice = {
  ...
  subchapters: [
    ...
    { id: 'stacks-problem', title: 'Stacks', problemId: 'stacks-problem' },
    { id: 'queues-problem', title: 'Queues', problemId: 'queues-problem' },
  ],
};
...
const chapter8Practice = {
  ...
  subchapters: [
    ...
    { id: 'tries-problem', title: 'Tries', problemId: 'tries-problem' },
    { id: 'graphs-problem', title: 'Graphs', problemId: 'graphs-problem' },
    { id: 'segment-trees-problem', title: 'Segment Trees', problemId: 'segment-trees-problem' },
  ],
};
